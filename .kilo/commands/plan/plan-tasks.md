...
7. **Generate task specifications** using `C:\py_dev\mko_telepost\.ai\tasks\templates\task_template.yaml`. 
...
11. **Generate execution ordering** using `C:\py_dev\mko_telepost\.ai\tasks\templates\order_template.yaml`. Numbering must match rollout order. No circular dependencies.
